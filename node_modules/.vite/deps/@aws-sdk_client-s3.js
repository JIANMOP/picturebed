    ...
    if (h2 === "retry-after") {
      ...
      if (retryAfter.endsWith("GMT")) {
        try {
          ...
          (_a3 = logger == null ? void 0 : logger.trace) == null ? void 0 : _a3.call(logger, "Failed to parse retry-after header");
          (_b2 = logger == null ? void 0 : logger.trace) == null ? void 0 : _b2.call(logger, e2);
        }
      ...
      if (isNaN(backoffMilliseconds)) {
        (_d2 = logger == null ? void 0 : logger.trace) == null ? void 0 : _d2.call(logger, `Failed to parse x-amz-retry-after=${v2}`);
        return;
      }
    ...
    if (isRetryStrategyV2(retryStrategy)) {
      ...
      while (true) {
        try {
          ...
          totalRetryDelay += (((_b2 = retryToken == null ? void 0 : retryToken.$retryLog) == null ? void 0 : _b2.acquisitionDelay) ?? 0) + delay;
          if (delay > 0) {
  ...
  async refreshRetryTokenForRetry(token, errorInfo) {
    ...
    if (shouldRetry || isLongPoll) {
      ...
      if (!shouldRetry) {
        ...
        const nextToken = new DefaultRetryToken(0, token.getRetryCount() + 1, capacityCost, ((_b2 = token.isLongPoll) == null ? void 0 : _b2.call(token)) ?? false);
...
var loggerMiddleware = () => (next, context) => async (args) => {
  ...
  try {
    ...
    (_a3 = logger == null ? void 0 : logger.info) == null ? void 0 : _a3.call(logger, {
      clientName,
      commandName,
    ...
    const inputFilterSensitiveLog = overrideInputFilterSensitiveLog ?? context.inputFilterSensitiveLog;
    (_b2 = logger == null ? void 0 : logger.error) == null ? void 0 : _b2.call(logger, {
      clientName,
      commandName,
      input: inputFilterSensitiveLog(args.input),
      error,
...
var makePagedClientRequest = async (CommandCtor, client, input, withCommand = (_) => _, ...args) => {
  ...
  return await client.send(command2, ...args);
};
  ...
  return Object.assign(input, {
    ...
    userAgentAppId: async () => {
      ...
      if (!isValidUserAgentAppId(appId)) {
        const logger = ((_b2 = (_a3 = input.logger) == null ? void 0 : _a3.constructor) == null ? void 0 : _b2.name) === "NoOpLogger" || !input.logger ? console : input.logger;
...
var createDefaultUserAgentProvider = ({ serviceId, clientVersion }) => async (config) => {
  ...
  const osName = ((_a3 = navigator == null ? void 0 : navigator.userAgentData) == null ? void 0 : _a3.platform) ?? fallback.os(uaString) ?? "other";
...
var Crc32cJs = class {
  constructor() {
    ...
    __publicField(this, "crc", 4294967295);
  }
  update(data2) {
    let crc = this.crc;
    for (let i2 = 0; i2 < data2.length; ++i2) {
      crc = crc >>> 8 ^ T[(crc ^ data2[i2]) & 255];
    }
    this.crc = crc;
  }
  async digest() {
...
var selectChecksumAlgorithmFunction = (checksumAlgorithm, config) => {
  ...
  switch (checksumAlgorithm) {
    case ChecksumAlgorithm.MD5:
      return (checksumAlgorithms == null ? void 0 : checksumAlgorithms.MD5) ?? config.md5;
    case ChecksumAlgorithm.CRC32:
      return (checksumAlgorithms == null ? void 0 : checksumAlgorithms.CRC32) ?? Crc32Js;
    case ChecksumAlgorithm.CRC32C:
      return (checksumAlgorithms == null ? void 0 : checksumAlgorithms.CRC32C) ?? Crc32cJs;
    case ChecksumAlgorithm.CRC64NVME:
      return (checksumAlgorithms == null ? void 0 : checksumAlgorithms.CRC64NVME) ?? Crc64NvmeJs;
    case ChecksumAlgorithm.SHA1:
      return (checksumAlgorithms == null ? void 0 : checksumAlgorithms.SHA1) ?? config.sha1;
    case ChecksumAlgorithm.SHA256:
      return (checksumAlgorithms == null ? void 0 : checksumAlgorithms.SHA256) ?? config.sha256;
    default:
        ...
        if (bucketRegionHeader) {
          if (statusCode === 301 || statusCode === 400 && ((err == null ? void 0 : err.name) === "IllegalLocationConstraintException" || isHeadBucket)) {
            try {
              ...
              (_d2 = context.logger) == null ? void 0 : _d2.debug(`Redirecting from ${await clientConfig.region()} to ${actualRegion}`);
  ...
  async getS3ExpressIdentity(awsIdentity, identityProperties) {
    ...
    if (entry) {
      return entry.identity.then((identity) => {
        var _a3, _b2;
        const isExpired = (((_a3 = identity.expiration) == null ? void 0 : _a3.getTime()) ?? 0) < Date.now();
        if (isExpired) {
          return cache2.set(key, new S3ExpressIdentityCacheEntry(this.getIdentity(key))).identity;
        }
        const isExpiringSoon = (((_b2 = identity.expiration) == null ? void 0 : _b2.getTime()) ?? 0) < Date.now() + _S3ExpressIdentityProviderImpl.REFRESH_WINDOW_MS;
...
var ProtocolLib = class {
  ...
  async getErrorSchemaOrThrowBaseException(errorIdentifier, defaultNamespace, response, dataObject, metadata, getErrorSchema) {
    ...
    try {
      ...
      const d2 = dataObject;
      const message = (d2 == null ? void 0 : d2.message) ?? (d2 == null ? void 0 : d2.Message) ?? ((_a3 = d2 == null ? void 0 : d2.Error) == null ? void 0 : _a3.Message) ?? ((_b2 = d2 == null ? void 0 : d2.Error) == null ? void 0 : _b2.message);
  ...
  decorateServiceException(exception, additions = {}) {
    ...
    if (this.queryCompat) {
      ...
      errorObj.Type = (_a3 = error.Error) == null ? void 0 : _a3.Type;
      errorObj.Code = (_b2 = error.Error) == null ? void 0 : _b2.Code;
      errorObj.Message = ((_c2 = error.Error) == null ? void 0 : _c2.message) ?? ((_d2 = error.Error) == null ? void 0 : _d2.Message) ?? msg;
...
var XmlShapeDeserializer = class extends SerdeContextConfig {
  ...
  read(schema, bytes, key) {
    ...
    const xmlString = (((_a3 = this.serdeContext) == null ? void 0 : _a3.utf8Encoder) ?? toUtf8)(bytes);
...
var loadRestXmlErrorCode = (output, data2) => {
  var _a3;
  if (((_a3 = data2 == null ? void 0 : data2.Error) == null ? void 0 : _a3.Code) !== void 0) {
...
var XmlShapeSerializer = class extends SerdeContextConfig {
  ...
  write(schema, value) {
    ...
    if (ns.isStringSchema() && typeof value === "string") {
      ...
      this.byteBuffer = "byteLength" in value ? value : (((_a3 = this.serdeContext) == null ? void 0 : _a3.base64Decoder) ?? fromBase64)(value);
    } else {
  ...
  writeSimple(_schema, value) {
    ...
    if (value && typeof value === "object") {
      if (ns.isBlobSchema()) {
        nodeContents = (((_a3 = this.serdeContext) == null ? void 0 : _a3.base64Encoder) ?? toBase64)(value);
...
var AwsRestXmlProtocol = class extends HttpBindingProtocol {
  ...
  async handleError(operationSchema, context, response, dataObject, metadata) {
    ...
    const message = ((_a3 = dataObject.Error) == null ? void 0 : _a3.message) ?? ((_b2 = dataObject.Error) == null ? void 0 : _b2.Message) ?? dataObject.message ?? dataObject.Message ?? "UnknownError";
    ...
    for (const [name, member] of ns.structIterator()) {
      ...
      const value = ((_c2 = dataObject.Error) == null ? void 0 : _c2[target]) ?? dataObject[target];
  ...
  return (next) => async (args) => {
    ...
    if (options.expectContinueHeader !== false && HttpRequest.isInstance(request) && request.body && options.runtime === "node" && ((_b2 = (_a3 = options.requestHandler) == null ? void 0 : _a3.constructor) == null ? void 0 : _b2.name) !== "FetchHttpHandler") {
      ...
      if (typeof options.expectContinueHeader === "number") {
        try {
          const bodyLength = Number((_c2 = request.headers) == null ? void 0 : _c2["content-length"]) ?? ((_d2 = options.bodyLengthChecker) == null ? void 0 : _d2.call(options, request.body)) ?? Infinity;
...
var AwsSdkSigV4Signer = class {
  async sign(httpRequest, identity, signingProperties) {
    ...
    if (((_a3 = handlerExecutionContext == null ? void 0 : handlerExecutionContext.authSchemes) == null ? void 0 : _a3.length) ?? 0 > 1) {
...
var AwsSdkSigV4ASigner = class extends AwsSdkSigV4Signer {
  async sign(httpRequest, identity, signingProperties) {
    ...
    const configResolvedSigningRegionSet = await ((_a3 = config.sigv4aSigningRegionSet) == null ? void 0 : _a3.call(config));
...
var _mw1 = (Command2, cs, config, o2) => [
  getThrow200ExceptionsPlugin(config),
  getSsecPlugin(config)
];
var _mw2 = (Command2, cs, config, o2) => [
  getThrow200ExceptionsPlugin(config),
  getLocationConstraintPlugin(config)
];
var _mw3 = (Command2, cs, config, o2) => [
  getFlexibleChecksumsPlugin(config, {
    requestAlgorithmMember: { "httpHeader": "x-amz-sdk-checksum-algorithm", "name": "ChecksumAlgorithm" },
    requestChecksumRequired: true
  })
];
var _mw4 = (Command2, cs, config, o2) => [];
var _mw5 = (Command2, cs, config, o2) => [
  getFlexibleChecksumsPlugin(config, {
    requestAlgorithmMember: { "httpHeader": "x-amz-sdk-checksum-algorithm", "name": "ChecksumAlgorithm" },
    requestChecksumRequired: true
  }),
...
var _mw6 = (Command2, cs, config, o2) => [
  getFlexibleChecksumsPlugin(config, {
...
var _mw7 = (Command2, cs, config, o2) => [
  getFlexibleChecksumsPlugin(config, {
    requestChecksumRequired: false,
    requestValidationModeMember: "ChecksumMode",
    responseAlgorithms: ["CRC64NVME", "CRC32", "CRC32C", "SHA256", "SHA1", "SHA512", "MD5", "XXHASH64", "XXHASH3", "XXHASH128"]
...
var _mw9 = (Command2, cs, config, o2) => [
  getFlexibleChecksumsPlugin(config, {
    requestAlgorithmMember: { "httpHeader": "x-amz-sdk-checksum-algorithm", "name": "ChecksumAlgorithm" },
    requestChecksumRequired: false
  })
];
var _mw10 = (Command2, cs, config, o2) => [
  getFlexibleChecksumsPlugin(config, {
    requestAlgorithmMember: { "httpHeader": "x-amz-sdk-checksum-algorithm", "name": "ChecksumAlgorithm" },
    requestChecksumRequired: false
  }),
...
var _mw12 = (Command2, cs, config, o2) => [
  getSsecPlugin(config)
];
var _mw13 = (Command2, cs, config, o2) => [
  getFlexibleChecksumsPlugin(config, {
    requestAlgorithmMember: { "httpHeader": "x-amz-sdk-checksum-algorithm", "name": "ChecksumAlgorithm" },
    requestChecksumRequired: false
  }),
...
var NoSuchAnnotation = class _NoSuchAnnotation extends S3ServiceException {
  constructor(opts) {
    ...
    __publicField(this, "name", "NoSuchAnnotation");
    __publicField(this, "$fault", "client");
...
var InvalidPrefix = class _InvalidPrefix extends S3ServiceException {
  constructor(opts) {
    ...
    __publicField(this, "name", "InvalidPrefix");
    __publicField(this, "$fault", "client");
...
var AnnotationLimitExceeded = class _AnnotationLimitExceeded extends S3ServiceException {
  constructor(opts) {
    ...
    __publicField(this, "name", "AnnotationLimitExceeded");
    __publicField(this, "$fault", "client");
...
var AnnotationNameTooLong = class _AnnotationNameTooLong extends S3ServiceException {
  constructor(opts) {
    ...
    __publicField(this, "name", "AnnotationNameTooLong");
    __publicField(this, "$fault", "client");
...
var InvalidAnnotationName = class _InvalidAnnotationName extends S3ServiceException {
  constructor(opts) {
    ...
    __publicField(this, "name", "InvalidAnnotationName");
    __publicField(this, "$fault", "client");
...
var UnsupportedMediaType = class _UnsupportedMediaType extends S3ServiceException {
  constructor(opts) {
    ...
    __publicField(this, "name", "UnsupportedMediaType");
    __publicField(this, "$fault", "client");
...
var Sha1Js = class _Sha1Js {
  constructor(secret) {
    ...
    __publicField(this, "buffer", new Uint8Array(BLOCK));
  ...
  update(data2) {
    ...
    if (this.bufferLength > 0) {
      while (length > 0 && this.bufferLength < BLOCK) {
        this.buffer[this.bufferLength++] = data2[pos++];
        --length;
      }
  ...
  hashBuffer(data2, offset) {
    this.hashBufferWith(this.state, data2, offset);
  }
  hashBufferWith(state, data2, offset) {
    const w2 = this.w ?? (this.w = new Int32Array(80));
    let s0 = state[0], s1 = state[1], s2 = state[2], s3 = state[3], s4 = state[4];
    for (let t8 = 0; t8 < 16; ++t8) {
      w2[t8] = (data2[offset + t8 * 4] & 255) << 24 | (data2[offset + t8 * 4 + 1] & 255) << 16 | (data2[offset + t8 * 4 + 2] & 255) << 8 | data2[offset + t8 * 4 + 3] & 255;
    }
    ...
    for (let t8 = 0; t8 < 80; ++t8) {
      ...
      const temp = ((s0 << 5 | s0 >>> 27) + (r2 === 0 ? s1 & s2 ^ ~s1 & s3 : r2 === 2 ? s1 & s2 ^ s1 & s3 ^ s2 & s3 : s1 ^ s2 ^ s3) | 0) + (s4 + (K2[r2] + w2[t8] | 0) | 0) | 0;
      s4 = s3;
      s3 = s2;
      s2 = s1 << 30 | s1 >>> 2;
      s1 = s0;
...
var getRuntimeConfig = (config) => {
  return {
    ...
    md5: (config == null ? void 0 : config.md5) ?? Md5Js,
    protocol: (config == null ? void 0 : config.protocol) ?? S3RestXmlProtocol,
    ...
    sha1: (config == null ? void 0 : config.sha1) ?? Sha1Js,
    sha256: (config == null ? void 0 : config.sha256) ?? Sha256WebCrypto,
...
var paginateListObjectAnnotations = createPaginator(S3Client, ListObjectAnnotationsCommand, "ContinuationToken", "NextContinuationToken", "MaxAnnotationResults");
