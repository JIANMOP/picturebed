...
var RETRY_CODE_LIST = __spread(FREEZE_CODE_LIST, [406]);
  ...
  (function(_super) {
    ...
    Direct2.prototype.run = function() {
      return __awaiter6(this, void 0, void 0, function() {
        var formData, fileBlob, crcSign, customVars_1, metadata_1, result;
        var _this = this;
          ...
          switch (_a2.label) {
            case 0:
              ...
              if (this.putExtra.mimeType) {
                fileBlob = this.file.slice(0, this.file.size, this.putExtra.mimeType);
...
function normalizeUploadConfig(config, logger) {
  ...
  var normalizeConfig = __assign6({ uphost: [], retryCount: 3, checkByMD5: false, forceDirect: false, useCdnDomain: true, checkByServer: true, concurrentRequestLimit: 3, chunkSize: DEFAULT_CHUNK_SIZE, upprotocol: "https", debugLogLevel: "OFF", disableStatisticsReport: false }, otherConfig);
  if (upprotocol) {
